...
////// Emissive:
                ...
                float2 node_6215 = (i.uv0+(node_1580.g*_RippleSpeed)*float2(1,0.6));
                ...
                float2 node_2332 = (i.uv0+(node_3868.g*_RippleSpeed_copy)*float2(1,-0.5));
