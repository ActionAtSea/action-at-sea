...
{    
    ...
    //Colour for AI ships = grey
    public Color m_playerColor = new Color(1.0f, 1.0f, 1.0f);
    private int m_aiIndex = -1; //Find out what this is for. (just an identifier from the networkmatchmaker based on the number of players in a room.)
    ...
    private int m_playerID = -1;    //an actor ID retrieved from photon networking
    ...
    void PlaceOnSpawn()
    {
        //Positions the ship at an available spawn point.
        //TODO: Get an ai version of this stuff.
    ...
    void OnDestroy()
    {
        //Figure out what to do when an AI ship is destroyed.
    ...
    void LateUpdate()
    {
        ...
        if(Diagnostics.IsActive())
        {
            ...
            if(photonView.isMine)
            {
                //TODO: figure out what to do with diagnostic stuff
